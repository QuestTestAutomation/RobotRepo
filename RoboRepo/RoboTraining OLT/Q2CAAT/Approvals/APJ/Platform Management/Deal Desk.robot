...
${platform mgmt license product #1}      SFF-SCL-TB
${platform mgmt license product #2}      SEC-SCL-TB
${platform mgmt license product #3}      EOG-MLX-PB-247
${platform mgmt license product #4}      XAF-NPO-TB-PRE
...
*** Test Cases ***
Platform Mgmt. APJ Direct - New Sales On-Prem License - More than 55% Discount - APPROVER IS Sales Manager /Country Manager / Director, Regional Business Unit Sales Leader, Deal Desk
    [Tags]    C313411
    ${APJ direct account oppty USD}       ${platform mgmt license product #2}	    ${discount range USD}[0]    ${APJ step 3 rule}	   ${apj pm mgr rule}    ${APJ FieldOps rule}
    ${APJ direct account oppty USD}       ${platform mgmt license product #2}	    ${discount range USD}       ${APJ step 3 rule}     ${apj pm mgr rule}    ${APJ FieldOps rule}
    ${APJ direct account oppty USD}       ${platform mgmt license product #2}	    ${discount range USD}[1]    ${APJ step 3 rule}     ${apj pm mgr rule}    ${APJ FieldOps rule}

 
Platform Mgmt. APJ Direct - New Sales On-Prem License - More than 87% (Chinese RMB) - APPROVER IS Sales Manager /Country Manager / Director, Regional Business Unit Sales Leader, Deal Desk
    [Tags]    C408784
 #--------------------------------------------------------------------------------------------------------------------------
...
Platform Mgmt. APJ Direct - New Sales On-Prem License - More than 82% (Korea Won) - APPROVER IS Sales Manager /Country Manager / Director, Regional Business Unit Sales Leader, Deal Desk
    [Tags]    C408783
 #--------------------------------------------------------------------------------------------------------------------------
 # Oppty                       `        |   Prodcuct                       |  Discount Range
 #-------------------------------------------------------------------------------------------------------------------------- 
...
Platform Mgmt. APJ Direct - New Sales On-Prem License - More than 64% (Singapore Dollars) - APPROVER IS Sales Manager /Country Manager / Director, Regional Business Unit Sales Leader, Deal Desk
    [Tags]    C408782
 #--------------------------------------------------------------------------------------------------------------------------
 # Oppty                       `        |   Prodcuct                       |  Discount Range
 #-------------------------------------------------------------------------------------------------------------------------- 
